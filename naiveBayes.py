...
loadData.run(8)
tDict = copy.deepcopy(loadData.teamDict)
loadData.teamDict = dict()
loadData.run(9)
vDict = copy.deepcopy(loadData.teamDict)

class NaiveBayes:
    """
    Modified NaiveBayes from the Berkeley open source Pacman project.
    """
    def __init__(self):
        self.legalLabels = ["Win","Loss","Tie"] #output labels
